...
class DataCollator:
    ...
    def __call__(self, features):
        ...
        # Print an example from the batch for debugging
...
def main(args):
    ...
    special_tokens_dict = {'additional_special_tokens': ['<e>', '</e>', '[ENTITY]']}
    ...
    k = 0.06  # Number of negative examples per positive example
